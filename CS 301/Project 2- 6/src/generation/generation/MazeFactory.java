...
public class MazeFactory implements Factory {
	...
	public boolean order(Order order) {
		...
		case DFS :
			builder = deterministic? new MazeBuilder(false) : new MazeBuilder();
			buildOrder();
			break; 
		case Prim:
			builder = deterministic? new MazeBuilderPrim(false) : new MazeBuilderPrim();
			buildOrder();
			break;
		case Eller:
			builder = deterministic? new MazeBuilderEller(false) : new MazeBuilderEller();
			buildOrder();
			break;
		default:
