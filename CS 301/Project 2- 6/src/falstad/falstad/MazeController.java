...
public class MazeController implements Order {
	...
	public MazeApplication mazeApplication;
	...
	protected void notifyViewerRedraw() {
		...
		panel.update() ;
		mazeApplication.setVisible(true);
	...
	public void deliver(MazeConfiguration mazeConfig) {
		...
		robot.setMaze(this);
		System.out.println(this.pledgeDriver);
		if (this.wallFollowerDriver != null) {
			wallFollowerDriver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
			wallFollowerDriver.setDistance(this.getMazeConfiguration().getMazedists());

			switchToPlayingScreen();

			try {
				System.out.println(getCurrentPosition()[0]);
				System.out.println(getCurrentPosition()[1]);

				wallFollowerDriver.drive2Exit();
			} catch (Exception e) {
			...
			pledgeDriver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
			pledgeDriver.setDistance(this.getMazeConfiguration().getMazedists());
			switchToPlayingScreen();
			try {
				System.out.println(getCurrentPosition()[0]);
				System.out.println(getCurrentPosition()[1]);
			...
			explorerDriver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
			explorerDriver.setDistance(this.getMazeConfiguration().getMazedists());
			switchToPlayingScreen();
			try {
				System.out.println(getCurrentPosition()[0]);
				System.out.println(getCurrentPosition()[1]);
				explorerDriver.drive2Exit();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			manualDriver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
			manualDriver.setDistance(this.getMazeConfiguration().getMazedists());
			switchToPlayingScreen();
			try {
			...
			wizardDriver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
			wizardDriver.setDistance(this.getMazeConfiguration().getMazedists());
			switchToPlayingScreen();
			try {
				//System.out.println(getCurrentPosition()[0]);
				//System.out.println(getCurrentPosition()[1]);
    ...
    protected void setBasicRobot(BasicRobot robot) {
    	     this.robot = robot;
    }
    protected void setApplication(MazeApplication mazeApplication) {
	    this.mazeApplication = mazeApplication;
    }
    protected void setDriver(Wizard wizard) {
