...
public class MazeFactory implements Factory {
	...
	public boolean order(Order order) {
		...
		case DFS :
			builder = deterministic? new MazeBuilder() : new MazeBuilder();
			buildOrder();
			break; 
		case Prim:
			builder = deterministic? new MazeBuilderPrim() : new MazeBuilderPrim();
			buildOrder();
			break;
		case Eller:
			builder = deterministic? new MazeBuilderEller() : new MazeBuilderEller();
			buildOrder();
			break;
		default:
