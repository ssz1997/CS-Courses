package shouzhuosunandyingxumu.cs301.cs.wm.edu.amazebyshouzhuosunandyingxumu.generation;
...
public class Seg {
    ...
    public Seg(final int psx, final int psy, final int pdx, final int pdy,
        ...
        dx = pdx;
        dy = pdy;
        panel = DataHolder.getMazeController().getPanel();
        // check conditions
    ...
    private void initColor(final int distance, final int cc) {
        ...
        case 0:
            ...
            break;
        case 1:
        	panel.setColor(RGB_DEF, rgbValue, RGB_DEF);
            break;
        case 2:
        	panel.setColor(RGB_DEF, RGB_DEF, rgbValue);
            break;
        case 3:
        	panel.setColor(rgbValue, rgbValue, RGB_DEF);
            break;
        case 4:
        	panel.setColor(RGB_DEF, rgbValue, rgbValue);
            break;
        case 5:
